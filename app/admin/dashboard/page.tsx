...
export default function AdminDashboard() {
  ...
  const exportToPDF = (scope: 'all' | 'filtered') => {
    ...
    doc.setFontSize(18);
    doc.setTextColor(2, 132, 199); // primary slate
      ...
      <div className="flex justify-between items-start flex-wrap gap-4 border-b dark:border-slate-800 pb-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            {pullingRemote && (
              <span className="inline-flex items-center gap-1.5 text-xs text-slate-500 bg-slate-50 dark:bg-slate-950/20 px-2 py-0.5 rounded-md animate-pulse">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="inline-flex rounded-xl bg-white dark:bg-slate-900 border dark:border-slate-800 p-1 text-slate-700 dark:text-slate-200">
            <button
              ...
              className="p-2 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 rounded-lg flex items-center gap-1 text-xs font-bold transition-all cursor-pointer"
                    ...
                    <td className="py-3.5 px-6 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 dark:bg-slate-950/20 dark:hover:bg-slate-950/40 text-slate-600 dark:text-slate-400 transition-colors cursor-pointer"
          ...
          <>
            ...
            >
              ...
              <div className="p-6 border-b dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-slate-900/40">
                <div>
                  <span className="text-[10px] font-extrabold uppercase text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-950/20 px-2 py-0.5 rounded">Intake Profile</span>
